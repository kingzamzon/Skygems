...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse h-auto" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto menu">
                        <li><a href="#" class="page-scroll"> Home</a>
                        </li>
    ...
    <div class="main">
        ...
        <section class="ptb-100 bg-image overflow-hidden" image-overlay="8">
            ...
            <div class="hero-bottom-shape-two" style="background: url('assets/img/wave-shap.svg')no-repeat bottom center"></div>
                ...
                <div class="row align-items-center justify-content-lg-between justify-content-md-center">
                    <div class="col-md-5 col-lg-4">
                        <div class="about-content-right">
                            <img src="{{ asset('assets/img/app-mobile-image-2.png') }}" alt="about us" class="img-fluid">
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="screenshot-wrap">
                    ...
                    <div class="screen-carousel owl-carousel owl-theme dot-indicator">
                        ...
                        <img src="{{ asset('assets/img/02.png') }}" class="img-fluid" alt="screenshots" />
                ...
                <div class="row align-items-center justify-content-md-center justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="popular-price bg-white text-center single-pricing-pack mt-4">
                            <div class="price-img pt-4">
                                <img src="{{ asset('assets/img/priching-img-2.png') }}" alt="price" width="120" class="img-fluid">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="text-center bg-white single-pricing-pack mt-4">
                            <div class="price-img pt-4">
                                <img src="{{ asset('assets/img/priching-img-3.png') }}" alt="price" width="120" class="img-fluid">
                            </div>
                            <div class="py-4 border-0 pricing-header">
                    ...
                    <div class="col-12">
                        <div class="support-cta text-center mt-5">
                            <h5 class="mb-1"><span class="fas fa-headphones color-primary mr-3"></span>We're Here to Help You
                            </h5>
            ...
            <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12 col-lg-6 mb-5 mb-md-5 mb-sm-5 mb-lg-0">
                        <div class="img-wrap">
                            <img src="{{ asset('assets/img/health.png') }}" alt="download" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-6">
