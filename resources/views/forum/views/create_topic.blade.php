...
<main id="tt-pageContent">
    <div class="container">
        <div class="tt-wrapper-inner">
            ...
            @endif
            <form class="form-default form-create-topic" action="{{route('forum.storeTopic')}}" method="POST">
                @csrf
                ...
                <div class="pt-editor">
                    ...
                    <div class="form-group">
                        <textarea id='editor1' name="body" class="form-control" rows="5" placeholder="Lets get started"></textarea>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
